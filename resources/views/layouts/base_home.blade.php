<html>
    <head>
        ...
        <script src='{{URL::to("js/function/oscura.js")}}' defer></script>
        <script src='{{URL::to("js/function/apriMenu.js")}}' defer></script>
        <script src='{{URL::to("js/function/cambiaLive.js")}}' defer></script>
        @yield('head')
    </head>
    <body>
        <header id="index">
