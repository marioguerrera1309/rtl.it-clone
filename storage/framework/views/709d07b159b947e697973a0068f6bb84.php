<html>
    <head>
        ...
        <link href='<?php echo e(URL::to("css/registration.css")); ?>' rel="stylesheet" type="text/css">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <script src='<?php echo e(URL::to("js/registration.js")); ?>' defer></script>
    </head>
    <body>
        <section>
...
</html><?php /**PATH C:\Users\Aguer\OneDrive - Università degli Studi di Catania\Desktop\Ingegneria Informatica\Database and Web Programming\Web programming\Rtl.it\hw2\resources\views/registration.blade.php ENDPATH**/ ?>